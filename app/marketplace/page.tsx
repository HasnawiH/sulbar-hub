...
const marketplaceData: Product[] = [
    ...
    { id: 2, title: 'Tenun Ikat Dari Kalumpang', type: 'barang', desc: "Tenun sutra asli Kalumpang Mamuju dengan motif khas.", category: 'Kain Tenun & Pakaian', imageUrl: 'images/SEKOMANDI.jpg', price: 1500000, rating: 4.3, sellerWA: '628111222333' },
    ...
    { id: 7, title: 'Golla Kambu', type: 'barang', desc: "Makanan ringan tradisional dari beras ketan.", category: 'Kuliner & Oleh-oleh', imageUrl: 'https://indonesia.go.id/assets/upload/headline/531CC2AA-CAD8-4A20-83C2-AF4773852269_thumb.jpeg', price: 20000, rating: 4.3, sellerWA: '628111222333' },
    { id: 8, title: 'Golla Kambu', type: 'barang', desc: "Makanan ringan tradisional dari beras ketan.", category: 'Kuliner & Oleh-oleh', imageUrl: 'https://indonesia.go.id/assets/upload/headline/531CC2AA-CAD8-4A20-83C2-AF4773852269_thumb.jpeg', price: 20000, rating: 4.3, sellerWA: '628111222333' },
...
export default function MarketplacePage() {
    const [activeType, setActiveType] = useState<'barang' | 'jasa'>('barang');
    ...
    return (
        <div className="min-h-screen pb-20 bg-gray-50">
            ...
            <main className="container mx-auto px-4 pt-24 pb-4">
                <section className="relative h-24 md:h-[44vh]  w-full overflow-hidden rounded-2xl shadow-xl mb-8">
                    <img
                        src="images/BNLAPAK.png"
                        alt="Kekayaan Budaya Senya Mandar"
                        className='w-full object-cover'
                    />
                    <div className="absolute inset-0 bg-black opacity-30"></div>
                </section>
                <div className="flex max-w-xl space-x-2 mb-6 p-1 bg-gray-200 ">
                    <button
                        onClick={() => setActiveType('barang')}
                        className={`flex-1 py-2 text-sm font-semibold transition-colors ${activeType === 'barang' ? 'bg-[#1A3D64] text-white shadow-md' : 'text-gray-700'
                            }`}
                    >
                        Barang
                    </button>
                    <button
                        ...
                        className={`flex-1 py-2 text-sm font-semibold transition-colors ${activeType === 'jasa' ? 'bg-[#1A3D64] text-white shadow-md' : 'text-gray-700'
                            }`}
                    >
                        Jasa
                    </button>
                ...
                <section>
                    <h2 className="text-xl font-extrabold text-gray-900 mb-4 pt-6">
